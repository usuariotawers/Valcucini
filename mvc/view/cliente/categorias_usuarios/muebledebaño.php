<?php require_once(__DIR__ . '/../../../controller/usuarios/categorias_usuarios/MuebledebanoController.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaBano/ProdBano1.php" method="get">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaBano/ProdBano2.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaBano/ProdBano3.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
