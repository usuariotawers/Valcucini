<?php require_once(__DIR__ . '/../../../controller/usuarios/categorias_usuarios/CocinasController.php'); ?>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="dropdown user-dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        <li><a class="dropdown-item" href="../../cliente/mi_cuenta.html">MI CUENTA</a></li>
        ...
        <div class="row g-4 card-grid">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto1['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 1">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto1['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina1.php" method="get">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto2['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 2">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto2['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina2.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto3['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 3">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto3['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina3.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto4['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 4">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto4['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina4.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto5['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 5">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto5['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina5.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto6['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 6">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto6['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina6.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto7['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 7">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto7['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina7.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto8['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 8">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto8['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina8.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto9['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 9">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto9['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina9.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    <img src="../../../<?= htmlspecialchars($producto10['url_imagenes']) ?>" class="card-img-top rounded" alt="Cocina 10">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <br><h6 class="card-title fw-bold"><?= htmlspecialchars($producto10['nombre']) ?></h6><br>
                        <form action="CategoriaCocina/ProdCocina10.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
