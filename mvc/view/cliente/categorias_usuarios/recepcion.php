<?php require_once(__DIR__ . '/../../../controller/usuarios/categorias_usuarios/RecepcionController.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaRecepcion/ProdRecepcion1.php" method="get">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaRecepcion/ProdRecepcion2.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaRecepcion/ProdRecepcion3.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaRecepcion/ProdRecepcion4.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaRecepcion/ProdRecepcion5.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaRecepcion/ProdRecepcion6.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
