            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaEscritorios/ProdEscritorio1.php" method="get">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaEscritorios/ProdEscritorio2.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaEscritorios/ProdEscritorio3.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaEscritorios/ProdEscritorio4.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaEscritorios/ProdEscritorio5.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card h-100 p-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <form action="CategoriaEscritorios/ProdEscritorio6.php" method="get">
                            <button type="submit" class="custom-button">ver más</button>
                        </form>
                    </div>
                </div>
