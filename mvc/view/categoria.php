  ...
  <div class="modal fade" id="modal1" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content modal-content-cate">
        ...
        <form action="categorias/cocinas.php">
  ...
  <div class="modal fade" id="modal2" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content modal-content-cate">
        ...
        <form action="categorias/closet.php">
        <button type="submit" class="btn btn-dark w-100 modal-button">Ver categoría</button>
      </form>
      </div>
    </div>
  ...
  <div class="modal fade" id="modal3" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content modal-content-cate">
        ...
        <form action="categorias/escritorios.php">
          <button type="submit" class="btn btn-dark w-100 modal-button">Ver categoría</button>
        </form>
      </div>
    </div>
  ...
  <div class="modal fade" id="modal4" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content modal-content-cate">
        ...
        <form action="categorias/muebledebaño.php">
          <button type="submit" class="btn btn-dark w-100 modal-button">Ver categoría</button>
        </form>
      </div>
    </div>
  ...
  <div class="modal fade" id="modal5" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content modal-content-cate">
        ...
        <form action="categorias/recepcion.php">
          <button type="submit" class="btn btn-dark w-100 modal-button">Ver categoría</button>
        </form>
      </div>
    </div>
  ...
  <div class="modal fade" id="modal6" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content modal-content-cate">
        ...
        <form action="categorias/puertas.php">
          <button type="submit" class="btn btn-dark w-100 modal-button">Ver categoría</button>
        </form>
      </div>
    </div>
  ...
  <div class="modal fade" id="modal7" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content modal-content-cate">
        ...
        <form action="categorias/entretenimiento.php">
          <button type="submit" class="btn btn-dark w-100 modal-button">Ver categoría</button>
        </form>
      </div>
    </div>
  ...
  <div class="modal fade" id="modal8" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content modal-content-cate">
        ...
        <form action="categorias/mobiliario.php">
          <button type="submit" class="btn btn-dark w-100 modal-button">Ver categoría</button>
        </form>
      </div>
    </div>
