<?php require_once(__DIR__ . '/../../../controller/categorias/CategoriaMobiliariomuchomas/Prodmobiliario2Controller.php'); ?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
        ...
        <div class="row g-4 align-items-center">
            ...
            <article class="col-12 col-xl-6">
                <div class="product-details">
                    ...
                    <h6><a href="../mobiliario.php" class="btn-link">Volver</a></h6><br>
