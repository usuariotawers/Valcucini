            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_puertas/Puerta2.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        <h6><a href="../categorias-usuario/puertas.html" class="btn-link">Volver</a></h6><br>
                        <h1>Puerta en melamina oscuraa</h1>
                        <p> Puerta de interior con acabado elegante, instalada con bisagras y cerradura negra.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en tono oscuro con marco del mismo material.</li>
                            <li><strong>Colores:</strong> Marrón oscuro con vetas de madera y herrajes en negro</li>
                        </ul>
