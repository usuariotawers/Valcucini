...
<head>
    ...
    <title>Producto Mobiliario </title>
            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario4.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        <h6><a href="../categorias-usuario/mobiliario.html" class="btn-link">Volver</a></h6><br>
                        <h1>Repisa de baño con múltiples compartimentos</h1>
                        <p> Repisa vertical con espacios de almacenamiento de distintos tamaños</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina con acabado de madera oscura y paneles blancos.</li>
                            <li><strong>Colores:</strong> Madera oscura, blanco y fondo con revestimiento cerámico en tonos claros.</li>
                        </ul>
