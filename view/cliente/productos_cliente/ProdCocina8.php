            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Cocinas/Cocina8.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">                        
                        ...
                        <h1>Cocina Moderna Pura</h1>
                        <p>Estilo vanguardista con gabinetes sin tiradores y superficies limpias. Electrodomésticos integrados.</p>
                        <ul>
                            <li><strong>Materiales:</strong> MDF lacado en alto brillo, encimeras de porcelanato y detalles en acero negro mate.</li>
                            <li><strong>Colores:</strong> Blanco y negro con contrastes en gris oscuro y luces LED integradas.</li>
                        </ul>
