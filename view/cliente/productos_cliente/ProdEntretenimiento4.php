            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento4.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Centro de entretenimiento en acabado brillante con almacenamiento superior</h1>
                        <p> Mueble bajo con múltiples compartimentos, panel decorativo en alto brillo y almacenamiento superior con puertas cerradas..</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en acabado blanco brillante y detalles en gris oscuro.</li>
                            <li><strong>Colores:</strong> Blanco, gris oscuro y madera en el suelo.</li>
                        </ul>
