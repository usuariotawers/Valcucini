            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento1.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        <h6><a href="../categorias-usuario/entretinimiento.html" class="btn-link">Volver</a></h6><br>
                        <h1>Centro de entretenimiento con acabado en melamina</h1>
                        <p> Mueble de almacenamiento con compartimentos cerrados y abiertos, diseñado para integrar una pantalla y dispositivos electrónicos.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina con acabado brillante en tono beige y detalles en ranuras verticales para un diseño moderno.</li>
                            <li><strong>Colores:</strong> Beige claro con acentos en tonos neutros y suelo de madera oscura.</li>
                        </ul>
                        ...
                        <div class="specs">
                            ...
                            <a href="../../formulariopersonalizado.html" target="_blank" class="btn btn-formu "> Realiza tu cotización</a><button class="btn btn-outline-light btn-opinion ms-2" data-bs-toggle="modal" data-bs-target="#modalResena">
