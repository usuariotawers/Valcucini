            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_puertas/Puerta1.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Puerta con diseño de rejilla en melamina</h1>
                        <p> Puerta de diseño moderno con ranuras horizontales, ideal para ventilación</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en tono claro con acabado texturizado.</li>
                            <li><strong>Colores:</strong> Beige claro con textura de madera.</li>
                        </ul>
