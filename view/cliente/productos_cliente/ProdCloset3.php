            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Closets/Closet3.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">                        
                        ...
                        <h1>Closet de Temporada y Almacenamiento</h1>
                        <p>Armario con puertas cerradas, diseñado para guardar ropa de otra temporada y artículos poco utilizados.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina con acabado en madera clara y tiradores discretos.</li>
                            <li><strong>Colores:</strong>Blanco o madera clara con tonalidades neutras en el interior.</li>
                        </ul>
