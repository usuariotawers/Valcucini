            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Closets/Closet4.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">                        
                        ...
                        <h1>Closet de Zapatos y Complementos </h1>
                        <p>Estanterías diseñadas para organizar calzado de diferentes tipos, con espacio para bolsos y otros complementos.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Madera con acabados en laca brillante y soportes metálicos.</li>
                            <li><strong>Colores:</strong>Blanco con detalles en negro o metálico..</li>
                        </ul>
