            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Cocinas/Cocina9.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Cocina Contemporánea Chic</h1>
                        <p>Diseño abierto con barra desayunador y estanterías flotantes. Espacios de almacenamiento bien distribuidos.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Madera laminada en acabado natural, encimeras de granito y detalles en acero inoxidable.</li>
                            <li><strong>Colores:</strong> Tonos cálidos de madera con encimeras oscuras y electrodomésticos en acero.</li>
                        </ul>
