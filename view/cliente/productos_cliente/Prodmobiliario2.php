            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario2.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Alacena de almacenamiento flotante</h1>
                        <p> Alacena con compartimentos de puertas y cajones, combinando tonos de madera y blanco.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina con acabado de madera y blanco mate. Manijas negras empotradas.</li>
                            <li><strong>Colores:</strong> Madera natural, blanco y negro en detalles.</li>
                        </ul>
