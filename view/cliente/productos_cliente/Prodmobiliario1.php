            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario1.jpeg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Librero empotrado con iluminación LED</h1>
                        <p> Librero de pared con puertas en acabado de madera natural e iluminación LED integrada.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina con acabado en madera clara y bisagras metálicas.</li>
                            <li><strong>Colores:</strong> Madera clara con iluminación cálida y paredes blancas.</li>
                        </ul>
