            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_recepcion/Recepcion3.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Mostrador compacto en melamina con iluminación</h1>
                        <p>Mostrador de recepción compacto con estructura funcional y estética moderna.</p>
                        <ul>
                            <li><strong>Materiales:</strong> MDF con recubrimiento brillante y encimera de cuarzo.</li>
                            <li><strong>Colores:</strong> Blanco brillante, gris oscuro y detalles metálicos.</li>
                        </ul>
