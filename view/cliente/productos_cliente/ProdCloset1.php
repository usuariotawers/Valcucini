            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Closets/Closet1.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">                        
                        <h6><a href="../categorias/closet.html" class="btn-link">Volver</a></h6><br>
                        <h1>Closet Principal de Ropa Formal</h1>
                        <p>Estilo elegante con acabados de lujo y gabinetes de diseño sofisticado. Iluminación focalizada en áreas clave.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Madera con acabado en melamina oscura y rieles metálicos para las puertas corredizas.</li>
                            <li><strong>Colores:</strong>Tonos oscuros y neutros, combinados con detalles metálicos en los tiradores.</li>
                        </ul>
