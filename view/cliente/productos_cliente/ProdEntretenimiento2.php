            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento2.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">                        
                        ...
                        <h1>Centro de entretenimiento con panel decorativo y detalles en madera</h1>
                        <p> Mueble flotante con almacenamiento en combinación de colores, acompañado de un panel decorativo y listones de madera en los laterales..</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en tonos madera y blanco, con listones decorativos en melamina tono madera.</li>
                            <li><strong>Colores:</strong> Blanco, madera oscura y detalles en tonos neutros.</li>
                        </ul>
