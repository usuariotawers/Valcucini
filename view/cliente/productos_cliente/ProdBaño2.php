            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Baño/Baño2.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1> Mueble flotante en acabado blanco minimalista</h1>
                        <p> Vanitorio de diseño moderno y funcional, suspendido para dar una sensación de amplitud en el baño. Incorpora cajones con sistema de cierre suave para almacenamiento. </p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina blanca con superficie de protección plástica para mayor durabilidad y resistencia a la humedad. </li>
                            <li><strong>Colores:</strong> Blanco mate en el mueble, combinado con una encimera blanca brillante y grifería negra mate para un contraste elegante. </li>
                        </ul>
