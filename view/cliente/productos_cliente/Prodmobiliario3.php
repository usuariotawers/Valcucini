            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario3.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Biblioteca de esquina en negro y blanco</h1>
                        <p> Biblioteca de pared en esquina con compartimentos de diferentes tamaños</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en acabado negro con detalles en blanco.</li>
                            <li><strong>Colores:</strong> Negro y blanco en contraste con suelo de madera clara.</li>
                        </ul>
