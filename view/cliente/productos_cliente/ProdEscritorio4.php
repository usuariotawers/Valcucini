            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_escritorios/Escritorio4.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Escritorio ejecutivo con diseño robusto</h1>
                        <p>Escritorio de gran tamaño con estructura gruesa para uso ejecutivo</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en acabado mármol gris.</li>
                            <li><strong>Colores:</strong>Gris claro con suelo de porcelanato oscuro.</li>
                        </ul>
