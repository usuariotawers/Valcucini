            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Baño/Baño3.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Mueble de baño en melamina negra con puertas de tirador metálico</h1>
                        <p> Gabinete bajo lavamanos con dos puertas de apertura tradicional, equipadas con manijas metálicas en acabado plateado.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en acabado negro mate con bordes reforzados para mayor resistencia al uso diario. Encimera de superficie sólida en color beige con lavabo redondo empotrado. </li>
                            <li><strong>Colores:</strong> Negro profundo en el mueble, contrastado con encimera en beige claro y grifería cromada. </li>
                        </ul>
