            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_puertas/Puerta6.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Puerta en melamina clara.</h1>
                        <p> Puerta de interior en tono natural con manija negra y marco a juego.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina con acabado de madera clara.</li>
                            <li><strong>Colores:</strong> Madera clara con herrajes negros y paredes blancas.</li>
                        </ul>
