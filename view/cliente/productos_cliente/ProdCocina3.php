            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Cocinas/Cocina3.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Cocina Vanguardia Blanca</h1>                       
                        <p>Módulos inferiores con puertas y cajones, gabinetes superiores con puertas lisas. </p>
                        <ul>
                            <li><strong>Materiales:</strong> MMelamina con acabado semi-brillante, encimera en material sintético o piedra.  </li>
                            <li><strong>Colores:</strong> Tonos oscuros en gabinetes, mesón claro, detalles metálicos en manijas y electrodomésticos.</li>
                        </ul>
