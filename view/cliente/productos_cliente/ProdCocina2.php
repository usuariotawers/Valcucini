            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Cocinas/Cocina2.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Cocina Minimalista Urbana</h1>                      
                        <p> Cocina en forma de L con alacenas altas, cajoneras y espacio para estufa.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en acabado mate con cubierta de piedra sintética.</li>
                            <li><strong>Colores:</strong> Blanco, negro y gris claro.</li>
                        </ul>
