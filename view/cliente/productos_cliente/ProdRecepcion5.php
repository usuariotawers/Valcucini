            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_recepcion/Recepcion5.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <ul>
                            <li><strong>Materiales:</strong> Melamina con acabado texturizado y cubierta de acero inoxidable. </li>
                            <li><strong>Colores:</strong> Gris oscuro, negro y blanco. </li>
                        </ul>
