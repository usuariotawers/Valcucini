            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Closets/Closet5.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Closet Multifuncional</h1>
                        <p>Espacio adaptable con cajones, estantes y áreas de colgado para diferentes tipos de prendas.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en tonos neutros con rieles deslizantes y bisagras reforzadas.</li>
                            <li><strong>Colores:</strong>Gris claro con detalles oscuros en los bordes.</li>
                        </ul>
