            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Cocinas/Cocina6.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Cocina Clásica Sofisticada</h1>
                        <p>Gabinetes superiores e inferiores con diseño moderno y líneas rectas.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Madera con acabado en wengue, mesón en piedra o material sinterizado.</li>
                            <li><strong>Colores:</strong> Wengue en muebles, mesón claro, detalles metálicos en manijas y electrodomésticos.</li>
                        </ul>
