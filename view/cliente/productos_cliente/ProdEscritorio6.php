            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_escritorios/Escritorio6.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Estación de trabajo con diseño moderno</h1>
                        <p>Escritorio en L con estanterías y paneles decorativos de madera</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en tonos claros con detalles en negro.</li>
                            <li><strong>Colores:</strong>Madera clara, blanco y negro.</li>
                        </ul>
