...
<!-- PRODUCTO -->
            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Cocinas/Cocina1.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        <h6><a href="../categorias-usuario/cocinas.html" class="btn-link">Volver</a></h6><br>
                        <h1>Cocina Elegancia Natural</h1>
                        <p> Cocina integral con gabinetes superiores e inferiores, encimera espaciosa y área para electrodomésticos. </p>
                        <ul>
                            <li><strong>Materiales:</strong> Madera en acabado laminado y encimera de granito. </li>
                            <li><strong>Colores:</strong> Tonos madera natural, gris oscuro y detalles en acero inoxidable. </li>
                        </ul>
                        ...
                        <div class="specs">
                            ...
                            <a href="../../formulariopersonalizado.php" target="_blank" class="btn btn-formu "> Realiza tu cotización</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="formResena" method="POST" action="../../../controller/guardar_resena.php">
        <div class="modal-content text-manrope">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="opinion" name="opinion" rows="3" placeholder="Cuéntanos qué te gusta o qué no te gusta" required></textarea>
            </div>

            <div class="mb-3">
              <label for="titulo" class="form-label">Agrega un título</label>
              <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Resume tu experiencia" required>
            </div>
            ...
            <!-- Puedes cambiar estos valores con PHP dinámico si es necesario -->
            <input type="hidden" name="id_usuario" value="7">
