            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario5.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Mesa de juntas con acabado en melamina</h1>
                        <p> Mesa cuadrada de gran tamaño para reuniones, acompañada de sillas negras ergonómicas.</p>
                        <ul>
                            <li><strong>Materiales:</strong> MMelamina en acabado gris con base sólida del mismo material.</li>
                            <li><strong>Colores:</strong> Gris claro, sillas negras y suelo oscuro.</li>
                        </ul>
