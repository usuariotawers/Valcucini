            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_escritorios/Escritorio3.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Mesa de trabajo compartida con almacenamiento</h1>
                        <p>Gran mesa de trabajo compartida para oficina, con varias estaciones y cajoneras individuales.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina con acabado tipo mármol gris claro.</li>
                            <li><strong>Colores:</strong>Gris claro con sillas negras y suelo oscuro.</li>
                        </ul>
