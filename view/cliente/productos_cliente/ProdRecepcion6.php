            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_recepcion/Recepcion6.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Mostrador de recepción con vitrina de exhibición</h1>
                        <p> Mostrador de recepción con diseño innovador, incorporando una vitrina de vidrio y estructura con listones de madera.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Madera en tonos oscuros con cubierta de granito pulido.</li>
                            <li><strong>Colores:</strong> Café oscuro, beige y detalles metálicos.</li>
                        </ul>
