            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Closets/Closet2.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Closet de Ropa Casual y Accesorios </h1>
                        <p>Estilo elegante con acabados de lujo y gabinetes de diseño sofisticado. Iluminación focalizada en áreas clave.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Paneles de melamina en acabado mate y herrajes metálicos..</li>
                            <li><strong>Colores:</strong>Beige o madera clara con contrastes oscuros en las manijas.</li>
                        </ul>
