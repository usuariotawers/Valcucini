            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento3.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Centro de entretenimiento con escritorio integrado</h1>
                        <p> Mueble multifuncional con escritorio, estantes abiertos y panel decorativo de listones verticales. Incluye iluminación empotrada.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en tonos madera clara y blanca, con detalles en listones de madera.</li>
                            <li><strong>Colores:</strong> Madera clara, blanco y detalles oscuros.</li>
                        </ul>
