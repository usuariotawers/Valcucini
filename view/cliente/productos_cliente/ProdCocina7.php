            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Cocinas/Cocina7.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Cocina Industrial Loft</h1>
                        <p>Diseño clásico con molduras en los gabinetes y vitrinas superiores. Distribución simétrica para mayor funcionalidad.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Madera pintada en tonos claros, encimeras de granito y tiradores de bronce envejecido.</li>
                            <li><strong>Colores:</strong> Crema y beige predominantes, con detalles en dorado y madera oscura en el suelo.</li>
                        </ul>
