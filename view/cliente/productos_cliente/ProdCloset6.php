            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Closets/Closet6.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        <h6><a href="../categorias-usuario/closet.html" class="btn-link">Volver</a></h6><br>
                        <h1>Closet Multifuncional Sencillo </h1>
                        <p>Estilo elegante con acabados de lujo y gabinetes de diseño sofisticado. Iluminación focalizada en áreas clave.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Lacado brillante en tonos oscuros, encimeras de mármol y herrajes dorados.</li>
                            <li><strong>Colores:</strong>Negro con detalles en dorado y mármol blanco en encimeras y salpicadero.</li>
                        </ul>
