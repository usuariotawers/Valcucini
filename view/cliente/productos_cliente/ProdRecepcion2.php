...
<head>
    ...
    <title>Producto Recepcion </title>
            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_recepcion/Recepcion2.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        <h6><a href="../categorias-usuario/recepcion.html" class="btn-link">Volver</a></h6><br>
                        <h1>Mostrador de recepción con cubierta de mármol sintético</h1>
                        <p>Mostrador largo de recepción con diseño minimalista y amplio espacio de trabajo.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Base en melamina con acabado en cemento pulido, superficie en mármol sintético negro y detalles en vidrio.</li>
                            <li><strong>Colores:</strong>Gris claro, negro brillante y detalles en vidrio translúcido.</li>
                        </ul>
