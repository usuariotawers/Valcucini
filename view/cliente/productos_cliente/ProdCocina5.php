            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Cocinas/Cocina5.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Cocina Compacta Industrial</h1>
                        <p>Módulos con divisiones internas, cajoneras y puertas lisas. </p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en acabado mate, vidrio o metal en detalles. </li>
                            <li><strong>Colores:</strong> Tonos oscuros predominan, mesón y algunos elementos en blanco o beige.</li>
                        </ul>
