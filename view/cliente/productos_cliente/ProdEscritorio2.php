            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_escritorios/Escritorio2.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Escritorio individual con cajonera lateral</h1>
                        <p>Escritorio compacto con tres cajones a un lado para almacenamiento.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina en acabado blanco envejecido.</li>
                            <li><strong>Colores:</strong>Blanco mate con detalles metálicos en las manijas.</li>
                        </ul>
