            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_recepcion/Recepcion1.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">                        
                        ...
                        <h1>Mostrador de recepción con acabado en listones de madera</h1>
                        <p>Mostrador de recepción en forma de "L", con diseño moderno y elegante.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Melamina con acabado en listones de madera en tonos naturales, con una superficie lisa y resistente.</li>
                            <li><strong>Colores:</strong>Tonos madera clara con detalles blancos y suelo oscuro.</li>
                        </ul>
