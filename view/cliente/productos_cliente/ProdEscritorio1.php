...
<head>
    ...
    <title>Producto Escritorio </title>
            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_escritorios/Escritorio1.jpeg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        <h6><a href="../categorias-usuario/escritorios.html" class="btn-link">Volver</a></h6><br>
                        <h1>Escritorio en L con almacenamiento superior</h1>
                        <p>Escritorio en forma de L con gabinetes superiores y repisas flotantes. Combinación de almacenamiento cerrado y abierto.</p>
                        <ul>
                            <li><strong>Materiales:</strong> Madera con acabado en melamina oscura y rieles metálicos para las puertas corredizas.</li>
                            <li><strong>Colores:</strong>Madera natural, blanco y suelo laminado en tonos similares.</li>
                        </ul>
