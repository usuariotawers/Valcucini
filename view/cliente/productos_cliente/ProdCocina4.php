            ...
            <div class="row g-4 align-items-center">
                <aside class="col-12 col-xl-6 d-flex justify-content-center mb-4">
                    <div class="pixelated-image-card">
                        <img src="../../assets/images/categoria_Cocinas/Cocina4.jpg" alt="Producto" class="pixelated-image top-image">
                ...
                <article class="col-12 col-xl-6">
                    <div class="product-details">
                        ...
                        <h1>Cocina Rústica Moderna </h1>                  
                        <p>Gabinetes superiores e inferiores con tiradores metálicos. </p>
                        <ul>
                            <li><strong>Materiales:</strong> MDF o madera procesada con revestimiento, mesón en piedra o sintético.  </li>
                            <li><strong>Colores:</strong> Marrón oscuro en muebles, mesón en beige claro.</li>
                        </ul>
