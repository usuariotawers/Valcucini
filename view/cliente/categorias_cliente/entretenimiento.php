            ...
            <div class="row g-4 card-grid">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento1.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Centro de entretenimiento con acabado en melamina</h6><br>
                            <form action="../productos-usuario/ProdEntretenimiento1.html" method="get">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento2.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Centro de entretenimiento con panel decorativo y detalles en madera</h6><br>
                            <form action="../productos-usuario/ProdEntretenimiento2.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5 ">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento3.jpg" class="card-img-top rounded" alt="Escritorio">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Centro de entretenimiento con escritorio integrado</h6><br>
                            <form action="../productos-usuario/ProdEntretenimiento3.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento4.jpg" class="card-img-top rounded" alt="Cocina">
                        <div class="card-body d-flex flex-column justify-content-between ">
                            <br><h6 class="card-title fw-bold ">Centro de entretenimiento en acabado brillante con almacenamiento superior</h6><br>
                            <form action="../productos-usuario/ProdEntretenimiento4.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento5.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Centro de entretenimiento</h6><br>
                            <form action="../productos-usuario/ProdEntretenimiento5.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5 ">
                        <img src="../../assets/images/categoria_entretenimiento/Centro de entretenimiento6.jpg" class="card-img-top rounded" alt="Escritorio">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Centro de entretenimiento</h6><br>
                            <form action="../productos-usuario/ProdEntretenimiento6.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
