            ...
            <div class="row g-4 card-grid">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario1.jpg" class="card-img-top rounded" alt="Mobiliario y mucho mas">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Librero empotrado con iluminación LED</h6><br>
                            <form action="../productos-usuario/Prodmobiliario1.html" method="get">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario2.jpg" class="card-img-top rounded" alt="Mobiliario y mucho mas">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Alacena de almacenamiento flotante</h6><br>
                            <form action="../productos-usuario/Prodmobiliario2.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5 ">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario3.jpg" class="card-img-top rounded" alt="Mobiliario y mucho mas">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Biblioteca de esquina en negro y blanco</h6><br>
                            <form action="../productos-usuario/Prodmobiliario3.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario4.jpg" class="card-img-top rounded" alt="Mobiliario y mucho mas">
                        <div class="card-body d-flex flex-column justify-content-between ">
                            <br><h6 class="card-title fw-bold ">Repisa de baño con múltiples compartimentos</h6><br>
                            <form action="../productos-usuario/Prodmobiliario4.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario5.jpg" class="card-img-top rounded" alt="Mobiliario y mucho mas">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mesa de juntas con acabado en melamina</h6><br>
                            <form action="../productos-usuario/Prodmobiliario5.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5 ">
                        <img src="../../assets/images/categoria_mobiliariomuchomas/Mobiliario6.jpg" class="card-img-top rounded" alt="Mobiliario y mucho mas">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mobiliario y mucho masMesa de juntas con acabado en melamina</h6><br>
                            <form action="../productos-usuario/Prodmobiliario6.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
