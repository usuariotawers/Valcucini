...
<!----------------- Categoria ------------------>
    <article>
        <h1 class="text-center my-5">Muebles de Baño</h1>
        <div class="container mt-4 text-center">
            <div class="row g-4 card-grid">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_Baño/Baño1.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mueble de baño con acabado en melamina tipo madera</h6><br>
                            <form action="../productos-usuario/ProdBaño1.html" method="get">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_Baño/Baño2.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mueble flotante en acabado blanco minimalista</h6><br>
                            <form action="../productos-usuario/ProdBaño2.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5 ">
                        <img src="../../assets/images/categoria_Baño/Baño3.jpg" class="card-img-top rounded" alt="Escritorio">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mueble de baño en melamina negra con puertas de tirador metálico</h6><br>
                            <form action="../productos-usuario/ProdBaño3.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
