...
<!----------------- Categoria ------------------>
    <article>
        <h1 class="text-center my-5">Escritorios</h1>
        <div class="container mt-4 text-center">
            <div class="row g-4 card-grid">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_escritorios/Escritorio1.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Escritorio en L con almacenamiento superior</h6><br>
                            <form action="../productos/ProdEscritorio1.html" method="get">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_escritorios/Escritorio2.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Escritorio individual con cajonera lateral</h6><br>
                            <form action="../productos/ProdEscritorio2.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5 ">
                        <img src="../../assets/images/categoria_escritorios/Escritorio3.jpg" class="card-img-top rounded" alt="Escritorio">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mesa de trabajo compartida con almacenamiento</h6><br>
                            <form action="../productos/ProdEscritorio3.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_escritorios/Escritorio4.jpg" class="card-img-top rounded" alt="Cocina">
                        <div class="card-body d-flex flex-column justify-content-between ">
                            <br><h6 class="card-title fw-bold ">Escritorio ejecutivo con diseño robusto</h6><br>
                            <form action="../productos/ProdEscritorio4.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_escritorios/Escritorio5.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Estación de trabajo con diseño moderno</h6><br>
                            <form action="../productos/ProdEscritorio5.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5 ">
                        <img src="../../assets/images/categoria_escritorios/Escritorio6.jpg" class="card-img-top rounded" alt="Escritorio">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Estación de trabajo con diseño moderno</h6><br>
                            <form action="../productos/ProdEscritorio6.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
