...
<!----------------- Categoria ------------------>
    <article>
        <h1 class="text-center my-5">RECEPCIÓN</h1>
        <div class="container mt-4 text-center">
            <div class="row g-4 card-grid">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_recepcion/Recepcion1.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mostrador de recepción con acabado en listones de madera</h6><br>
                            <form action="../productos-usuario/ProdRecepcion1.html" method="get">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_recepcion/2.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mostrador de recepción con cubierta de mármol sintético</h6><br>
                            <form action="../productos-usuario/ProdRecepcion2.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5 ">
                        <img src="../../assets/images/categoria_recepcion/Recepcion3.jpg" class="card-img-top rounded" alt="Escritorio">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mostrador compacto en melamina con iluminación</h6><br>
                            <form action="../productos-usuario/ProdRecepcion3.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_recepcion/Recepcion4.jpg" class="card-img-top rounded" alt="Cocina">
                        <div class="card-body d-flex flex-column justify-content-between ">
                            <br><h6 class="card-title fw-bold ">Mostrador de recepción con vitrina de exhibición</h6><br>
                            <form action="../productos-usuario/ProdRecepcion4.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5">
                        <img src="../../assets/images/categoria_recepcion/Recepcion5.jpg" class="card-img-top rounded" alt="Closet">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mostrador de recepción</h6><br>
                            <form action="../productos-usuario/ProdRecepcion5.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="card h-100 p-5 ">
                        <img src="../../assets/images/categoria_recepcion/Recepcion6.jpg" class="card-img-top rounded" alt="Escritorio">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <br><h6 class="card-title fw-bold ">Mostrador de recepción</h6><br>
                            <form action="../productos-usuario/ProdRecepcion6.html" method="get">
                                <button type="submit" class="custom-button">ver mas</button>
                            </form>
                        </div>
                    </div>
