...
<body>
    ...
    <div class="container text-center mb-5">
        <img src="../assets/images/header/fondo.jpg" alt="Avatar" class="avatar2">
            ...
            <aside>
                ...
                <form>
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input type="email" class="form-control2" required>
                    </div>
                    <div class="mb-3 text-start">
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <textarea class="form-control2" rows="3" required></textarea>
                    </div>
